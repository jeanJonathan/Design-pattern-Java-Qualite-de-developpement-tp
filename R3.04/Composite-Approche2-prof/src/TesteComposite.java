...
public class TesteComposite {
	...
	public static void main(String[] args) {
		...
		PreparationComposee sauceBolo = new PreparationComposee ("SAUCE BOLO", 2);
		sauceBolo.ajouterPreparationDeCuisine (viandeHachee);
		sauceBolo.ajouterPreparationDeCuisine (sauceTomate);

		PreparationComposee pateBolo = new PreparationComposee ("PATE BOLO", 1);
