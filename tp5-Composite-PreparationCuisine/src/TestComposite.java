...
public class TestComposite {
	...
	public static void main(String[] args) {
		...
		PreparationDeCuisine preparationPateBolo = new PreparationComposee();
		...
		PreparationDeCuisine preparationSauceBolo = new PreparationComposee();
		...
		PreparationDeCuisine preparationSauceTomate = new PreparationComposee();
		 ...
		 * reccursivement */
		System.out.println(preparationPateBolo.existeComposant(preparationPate));
